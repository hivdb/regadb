...
public class ImportUcsc 
{
	...
	private void handlePatientData()
	{
		...
		TestType acuteSyndromTestType = new TestType(StandardObjects.getNumberValueType(), null, StandardObjects.getPatientTestObject(), "Acute Syndrome", new TreeSet<TestNominalValue>());
