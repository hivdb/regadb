...
create table regadbschema.nt_sequence (nt_sequence_ii integer generated by default as identity (start with 1), version integer not null, viral_isolate_ii integer not null, label varchar(50), sequence_date date, nucleotides longvarchar, aligned bit not null, primary key (nt_sequence_ii));
