...
create table regadbschema.patient_attribute_value (patient_attribute_value_ii int identity not null, version int not null, attribute_ii int not null, patient_ii int not null, nominal_value_ii int null, value text null, primary key (patient_attribute_value_ii));
