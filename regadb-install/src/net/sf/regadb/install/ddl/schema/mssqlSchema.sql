...
create table regadbschema.patient_event_value (patient_event_value_ii int identity not null, version int not null, patient_ii int not null, nominal_value_ii int null, event_ii int not null, value varchar(100) null, start_date datetime null, end_date datetime null, primary key (patient_event_value_ii));
