...
create table regadbschema.nt_sequence (nt_sequence_ii integer default nextval('nt_sequence_nt_sequence_ii_seq'), version integer  not null, viral_isolate_ii integer  not null, label varchar(50), sequence_date date, nucleotides text, aligned bool DEFAULT true NOT NULL, primary key (nt_sequence_ii));
