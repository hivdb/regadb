...
create table public.analysis_data (analysis_data_ii integer default nextval('analysis_data_analysis_data_ii_seq'), analysis_ii integer not null, name varchar(50), data bytea, analysis_type_ii integer not null, primary key (analysis_data_ii));
...
create table public.drug_class (class_ii integer default nextval('drug_class_drug_class_ii_seq'), version integer not null, class_id varchar(10) not null, class_name varchar(100) not null, primary key (class_ii));
...
create table public.settings_user (uid varchar(50) not null, version integer not null, chart_resistance_test_ii integer, source_dataset_ii integer, chart_width integer not null, chart_height integer not null, password varchar(50), email varchar(100), first_name varchar(50), last_name varchar(50), admin bool, enabled bool, primary key (uid));
create table public.test (test_ii integer default nextval('test_test_ii_seq'), version integer not null, test_type_ii integer not null, description varchar(50) not null, service_class varchar(50), service_data varchar(255), service_config varchar(255), primary key (test_ii));
...
alter table public.settings_user add constraint FKDBFE06678EFD4F91 foreign key (chart_resistance_test_ii) references public.test;
alter table public.settings_user add constraint FKDBFE0667E89F1EEC foreign key (source_dataset_ii) references public.dataset;
