...
create table public.aa_insertion (position int2 not null, aa_sequence_ii integer  not null, insertion_order int2 not null, version integer  not null, aa_insertion varchar(30) not null, nt_insertion_codon varchar(3) not null, primary key (position, aa_sequence_ii, insertion_order));
create table public.aa_mutation (position int2 not null, aa_sequence_ii integer  not null, version integer  not null, aa_reference varchar(1) not null, aa_mutation varchar(30), nt_reference_codon varchar(3) not null, nt_mutation_codon varchar(3), primary key (position, aa_sequence_ii));
...
create table public.analysis (analysis_ii integer default nextval('analysis_analysis_ii_seq'), analysis_type_ii integer  not null, type integer , url varchar(100), account varchar(50), password varchar(100), baseinputfile varchar(50), baseoutputfile varchar(50), service_name varchar(100), primary key (analysis_ii));
...
create table public.dataset (dataset_ii integer default nextval('dataset_dataset_ii_seq'), version integer  not null, creator varchar(50) not null, description varchar(50) not null, creation_date date not null, closed_date date, revision integer , primary key (dataset_ii));
...
create table public.nt_sequence (nt_sequence_ii integer default nextval('nt_sequence_nt_sequence_ii_seq'), version integer  not null, viral_isolate_ii integer  not null, nucleotides text, label varchar(50), sequence_date date, primary key (nt_sequence_ii));
...
create table public.test (test_ii integer default nextval('test_test_ii_seq'), version integer  not null, analysis_ii integer  unique, test_type_ii integer  not null, description varchar(50) not null, service_class varchar(50), service_data text, service_config text, primary key (test_ii));
...
alter table public.dataset add constraint "FK_dataset_settings_user" foreign key (creator) references public.settings_user(creator) ON UPDATE CASCADE;
