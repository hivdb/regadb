...
create table public.query_definition (query_definition_ii integer default nextval('query_definition_query_definition_ii_seq'), uid varchar(50), name varchar(50), description text, query text, primary key (query_definition_ii));
