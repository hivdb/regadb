...
create table public.event_nominal_value (nominal_value_ii integer default nextval('event_nominal_value_event_nominal_value_ii_seq'), version integer  not null, event_ii integer  not null, value varchar(100) not null, primary key (nominal_value_ii));
