...
create table public.splicing_position (splicing_position_ii integer not null, version integer not null, protein_ii integer not null, position integer not null, primary key (splicing_position_ii));
