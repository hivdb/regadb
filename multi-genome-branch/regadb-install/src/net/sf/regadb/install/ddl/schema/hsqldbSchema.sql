...
create table regadbschema.patient (patient_ii integer generated by default as identity (start with 1), version integer not null, patient_id varchar(50) not null, last_name varchar(50), first_name varchar(50), birth_date date, death_date date, primary key (patient_ii));
