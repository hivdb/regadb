...
create table public.analysis (analysis_ii integer default nextval('analysis_analysis_ii_seq'), analysis_type_ii integer  not null, url varchar(100), account varchar(50), password varchar(100), baseinputfile varchar(50), baseoutputfile varchar(50), service_name varchar(100), dataoutputfile varchar(50), primary key (analysis_ii));
create table public.analysis_data (analysis_data_ii integer default nextval('analysis_data_analysis_data_ii_seq'), analysis_ii integer  not null, name varchar(50), data bytea, mimetype varchar(50) not null, primary key (analysis_data_ii));
...
create table public.event (event_ii integer default nextval('event_event_ii_seq'), version integer  not null, value_type_ii integer , name varchar(50) not null, primary key (event_ii));
...
create table public.genome (genome_ii integer default nextval('genome_genome_ii_seq'), version integer  not null, organism_name varchar(50) not null, organism_description varchar(500) not null, genbank_number varchar(50), primary key (genome_ii));
...
create table public.protein (protein_ii integer default nextval('protein_protein_ii_seq'), version integer  not null, open_reading_frame_ii integer  not null, abbreviation varchar(50) not null, full_name varchar(50), start_position integer  not null, stop_position integer  not null, primary key (protein_ii));
create table public.query_definition (query_definition_ii integer default nextval('query_definition_query_definition_ii_seq'), uid varchar(50), name varchar(50), description text, query text, query_type_ii integer  not null, primary key (query_definition_ii));
...
create table public.splicing_position (splicing_position_ii integer default nextval('splicing_position_splicing_position_ii_seq'), version integer  not null, protein_ii integer  not null, position integer  not null, primary key (splicing_position_ii));
...
create table public.test_type (test_type_ii integer default nextval('test_type_test_type_ii_seq'), version integer  not null, value_type_ii integer , genome_ii integer , test_object_ii integer  not null, description varchar(50) not null, primary key (test_type_ii));
create table public.therapy (therapy_ii integer default nextval('therapy_therapy_ii_seq'), version integer  not null, therapy_motivation_ii integer , patient_ii integer  not null, genome_ii integer , start_date date not null, stop_date date, comment varchar(50), primary key (therapy_ii));
create table public.therapy_commercial (therapy_ii integer  not null, commercial_ii integer  not null, version integer  not null, day_dosage_units float8, placebo bool not null, blind bool not null, frequency int8, primary key (therapy_ii, commercial_ii));
create table public.therapy_generic (therapy_ii integer  not null, generic_ii integer  not null, version integer  not null, day_dosage_mg float8, placebo bool not null, blind bool not null, frequency int8, primary key (therapy_ii, generic_ii));
...
create table public.user_attribute (user_attribute_ii integer default nextval('user_attribute_user_attribute_ii_seq'), value_type_ii integer , uid varchar(50), name varchar(50), value varchar(100), data bytea, primary key (user_attribute_ii));
...
alter table public.event add constraint "FK_event_value_type" foreign key (value_type_ii) references public.value_type(value_type_ii) ON UPDATE CASCADE;
create index event_nominal_value_event_ii_idx on public.event_nominal_value (event_ii);
alter table public.event_nominal_value add constraint "FK_event_nominal_value_event" foreign key (event_ii) references public.event(event_ii) ON UPDATE CASCADE;
...
alter table public.open_reading_frame add constraint "FK_open_reading_frame_genome" foreign key (genome_ii) references public.genome(genome_ii) ON UPDATE CASCADE;
...
alter table public.patient_event_value add constraint "FK_patient_event_value_event_nominal_value" foreign key (nominal_value_ii) references public.event_nominal_value(nominal_value_ii) ON UPDATE CASCADE;
alter table public.patient_event_value add constraint "FK_patient_event_value_patient" foreign key (patient_ii) references public.patient(patient_ii) ON UPDATE CASCADE;
alter table public.patient_event_value add constraint "FK_patient_event_value_event" foreign key (event_ii) references public.event(event_ii) ON UPDATE CASCADE;
create index protein_open_reading_frame_ii_idx on public.protein (open_reading_frame_ii);
alter table public.protein add constraint "FK_protein_open_reading_frame" foreign key (open_reading_frame_ii) references public.open_reading_frame(open_reading_frame_ii) ON UPDATE CASCADE;
...
alter table public.splicing_position add constraint "FK_splicing_position_protein" foreign key (protein_ii) references public.protein(protein_ii) ON UPDATE CASCADE;
...
alter table public.test_type add constraint "FK_test_type_genome" foreign key (genome_ii) references public.genome(genome_ii) ON UPDATE CASCADE;
...
alter table public.therapy add constraint "FK_therapy_genome" foreign key (genome_ii) references public.genome(genome_ii) ON UPDATE CASCADE;
...
alter table public.user_attribute add constraint "FK_user_attribute_value_type" foreign key (value_type_ii) references public.value_type(value_type_ii) ON UPDATE CASCADE;
alter table public.user_attribute add constraint "FK_user_attribute_settings_user" foreign key (uid) references public.settings_user(uid) ON UPDATE CASCADE;
