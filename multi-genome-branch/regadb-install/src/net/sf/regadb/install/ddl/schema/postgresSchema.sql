...
create table public.genome (genome_ii integer default nextval('genome_genome_ii_seq'), version integer  not null, organism_name varchar(50) not null, organism_description varchar(50) not null, genbank_number varchar(50), primary key (genome_ii));
...
create table public.open_reading_frame (open_reading_frame_ii integer default nextval('open_reading_frame_open_reading_frame_ii_seq'), version integer  not null, genome_ii integer  not null, name varchar(50) not null, description varchar(50) not null, reference_sequence text not null, primary key (open_reading_frame_ii));
