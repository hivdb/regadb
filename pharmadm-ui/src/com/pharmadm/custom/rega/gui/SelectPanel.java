...
public class SelectPanel extends javax.swing.JPanel {
    ...
    private void initSelectListComponents() {
        ...
        controller.getQueryEditor().addSelectionListChangeListener(new SelectionListChangeListener() {
    ...
    private void makeSelectListComponents() {
        Iterator<Selection> outputs = controller.getQueryEditor().getQuery().getSelectList().getSelections().iterator();
