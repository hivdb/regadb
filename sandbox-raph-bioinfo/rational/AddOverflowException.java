...
public class AddOverflowException extends OverflowException {
	 ...
	 * @effect This new add overflow exception is initialized in the same way an
	 *         overflow exception is initialized with the given left operand and
	 *         given right operand. | super(left,right)
	 */
