...
public class ISelectQueryRunDataTable implements IDataTable<QueryDefinition>
{
    ...
    {
        RegaDBMain.getApp().getTree().getTreeContent().queryRunSelected.setSelectedItem(selectedItem);
