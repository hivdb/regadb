...
The RegaDB v2.0 software package can be downloaded from our website (http://www.rega.kuleuven.be/cev/software/regadb), the regadb.war and postgresSchema.sql files are needed during the installation.
